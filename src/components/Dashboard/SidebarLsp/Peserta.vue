...
onMounted(() => {
  if (storeApp.tokenPeserta) {
    refreshToken();
  }
  user.value = JSON.parse(storeApp.userPeserta);
});
  ...
  axios
    ...
    .catch((err) => {
      ...
      confirmation(
        ...
        localStorage.removeItem("tokenPeserta");
        localStorage.removeItem("userPeserta");
        window.close();
      });
    });
}
      ...
      <div class="height-hide overflow-auto">
        <div class="menu-wrapper">
          ...
          >
            <div
              :class="`item d-flex align-items-center ${
                route.name == 'dashboard-lsp-peserta' ? 'active' : ''
              }`"
            >
              <div
                style="width: 20px"
          ...
          >
            <div
              :class="`item d-flex align-items-center ${
                route.meta.group == 'dashboard-lsp-peserta-diklat'
                  ? 'active'
                  : ''
              }`"
            >
