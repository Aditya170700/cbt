      ...
      <div class="height-hide overflow-auto">
        <div class="menu-wrapper">
          ...
          >
            <div
              :class="`item d-flex align-items-center ${
                route.name == 'dashboard-lsp-administrator' ? 'active' : ''
              }`"
            >
              <div
                style="width: 20px"
          ...
          >
            <div
              :class="`item d-flex align-items-center ${
                route.meta.group == 'dashboard-lsp-administrator-test'
                  ? 'active'
                  : ''
              }`"
            >
          ...
          >
            <div
              :class="`item d-flex align-items-center ${
                route.meta.group == 'dashboard-lsp-administrator-soal'
                  ? 'active'
                  : ''
              }`"
            >
          ...
          >
            <div
              :class="`item d-flex align-items-center ${
                route.meta.group == 'dashboard-lsp-administrator-template'
                  ? 'active'
                  : ''
              }`"
            >
