      ...
      <div class="height-hide overflow-auto">
        <div class="menu-wrapper">
          ...
          >
            <div
              :class="`item d-flex align-items-center ${
                route.name == 'dashboard-lsp-instruktur' ? 'active' : ''
              }`"
            >
              <div
                style="width: 20px"
          ...
          >
            <div
              :class="`item d-flex align-items-center ${
                route.meta.group == 'dashboard-lsp-instruktur-test'
                  ? 'active'
                  : ''
              }`"
            >
          ...
          >
            <div
              :class="`item d-flex align-items-center ${
                route.meta.group == 'dashboard-lsp-instruktur-soal'
                  ? 'active'
                  : ''
              }`"
            >
          ...
          >
            <div
              :class="`item d-flex align-items-center ${
                route.meta.group == 'dashboard-lsp-instruktur-template'
                  ? 'active'
                  : ''
              }`"
            >
