    ...
    >
      ...
      <div class="height-hide overflow-auto">
        <div class="menu-wrapper">
          <router-link
            :to="{ name: 'dashboard-panitia' }"
            class="text-white text-decoration-none"
            href="#"
          >
            <div
              :class="`item d-flex align-items-center ${
                route.name == 'dashboard-panitia' ? 'active' : ''
              }`"
            >
              <div
                style="width: 20px"
          ...
          >
            <div
              :class="`item d-flex align-items-center ${
                route.meta.group == 'dashboard-panitia-test' ? 'active' : ''
              }`"
            >
              <div
                style="width: 20px"
          ...
          >
            <div
              :class="`item d-flex align-items-center ${
                route.meta.group == 'dashboard-panitia-soal' ? 'active' : ''
              }`"
            >
              <div
                style="width: 20px"
          ...
          >
            <div
              :class="`item d-flex align-items-center ${
                route.meta.group == 'dashboard-panitia-template' ? 'active' : ''
              }`"
            >
              <div
                style="width: 20px"
