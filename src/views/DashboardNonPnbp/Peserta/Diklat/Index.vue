              ...
              <div class="card rounded-5 shadow border position-relative">
                ...
                <div class="card-body rounded-4 p-4">
                  <div class="h5 fw-bold">
                    {{
                      data.jenis_diklat_referensi_diklat.referensi_diklat.name
                    }}
                  </div>
                  <div class="h6 fw-bold">
                    {{
                      data.jenis_diklat_referensi_diklat.jenis_diklat.parent
                        .name
                    }}
                    /
                    {{ data.jenis_diklat_referensi_diklat.jenis_diklat.name }}
                  </div>
