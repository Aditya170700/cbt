...
onBeforeMount(() => {
  fetchData(`${storeApp.baseurl}cbt/non-pnbp/instruktur/test/list`);
  fetchDataLemdik();
});
...
function fetchDataLemdik() {
  lemdik.loading = true;
  axios
    .get(`${storeApp.baseurl}cbt/non-pnbp/instruktur/other/lemdik`, {
      headers: {
        Authorization: `Bearer ${storeApp.tokenInstruktur}`,
      },
      params,
          ...
          <div class="col-lg-3 text-end">
            <div class="input-group mb-3 bg-white rounded-2 shadow">
              ...
              <button
                ...
                @click="
                  fetchData(
                    `${storeApp.baseurl}cbt/non-pnbp/instruktur/test/list`
                  )
                "
              >
