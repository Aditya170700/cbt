...
onBeforeMount(() => {
  ...
  fetchQuestionNotInTest(
    `${storeApp.baseurl}cbt/non-pnbp/instruktur/soal/${route.params.id_test}/not-in-test/${route.params.table}`
  );
});
...
function fetchData() {
  ...
  axios
    .get(
      `${storeApp.baseurl}cbt/non-pnbp/instruktur/test/${route.params.id_test}/show/${route.params.table}`,
      {
        headers: {
...
function fetchTemplate() {
  ...
  axios
    .get(`${storeApp.baseurl}cbt/non-pnbp/instruktur/template/for-select`, {
      headers: {
        Authorization: `Bearer ${storeApp.tokenInstruktur}`,
      },
    })
...
function submit() {
  ...
  axios
    .post(
      `${storeApp.baseurl}cbt/non-pnbp/instruktur/test/attach-pertanyaan`,
      {
        bobot,
