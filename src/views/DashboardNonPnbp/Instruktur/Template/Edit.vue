...
onMounted(() => {
  ...
  axios
    .get(
      `${storeApp.baseurl}cbt/non-pnbp/instruktur/template/${route.params.id}/show`,
      {
        headers: {
    ...
    .then((res) => {
      ...
      fetchSoal(`${storeApp.baseurl}cbt/non-pnbp/instruktur/soal/for-template`);
    })
    .catch((err) => {
      form.loadingData = false;
      console.log(err);
...
function submit() {
  ...
  axios
    .put(
      `${storeApp.baseurl}cbt/non-pnbp/instruktur/template/${route.params.id}`,
      {
        name: form.name,
                  ...
                  <div class="col-6">
                    <div class="input-group mb-3 bg-white rounded-2 shadow">
                      ...
                      <button
                        ...
                        @click="
                          fetchSoal(
                            `${storeApp.baseurl}cbt/non-pnbp/instruktur/soal/for-template`
                          )
                        "
                      >
