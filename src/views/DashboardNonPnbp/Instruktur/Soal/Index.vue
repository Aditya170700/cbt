...
onBeforeMount(() => {
  fetchData(`${storeApp.baseurl}cbt/non-pnbp/instruktur/soal/list`);
});
...
function changeFile(e) {
  ...
  axios
    .post(`${storeApp.baseurl}cbt/non-pnbp/instruktur/soal-import`, formData, {
      headers: {
          ...
          <div class="col-lg-4">
            <div class="input-group mb-3 bg-white rounded-2 shadow">
              ...
              <button
                ...
                @click="
                  fetchData(
                    `${storeApp.baseurl}cbt/non-pnbp/instruktur/soal/list`
                  )
                "
              >
