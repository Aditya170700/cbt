...
onMounted(() => {
  fetchData(`${storeApp.baseurl}cbt/instruktur/template`);
});
...
function destroy(data) {
  confirmation("Yakin hapus data ini?").then((confirmed) => {
    if (confirmed) {
      data.loading = true;
      axios
        .delete(`${storeApp.baseurl}cbt/instruktur/template/${data.id}`, {
          headers: {
            Authorization: `Bearer ${storeApp.tokenInstruktur}`,
          },
        })
      ...
      <div class="container p-lg-4">
        <div class="d-flex px-2 mb-4 justify-content-between">
          ...
          <div class="col-5 col-lg-3 text-end mb-3">
            <router-link
              :to="{ name: 'dashboard-instruktur-template-create' }"
          ...
          <div class="col-5 col-lg-3 text-end mb-3">
            <div class="input-group mb-3 bg-white rounded-2 shadow">
              ...
              <button
                ...
                type="button"
                id="btn-search"
                @click="fetchData(`${storeApp.baseurl}cbt/instruktur/template`)"
              >
