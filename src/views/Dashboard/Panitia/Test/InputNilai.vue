...
function fetchData() {
  ...
  axios
    .get(
      `${storeApp.baseurl}cbt/panitia/test/${route.params.id_test}/list-jawaban/${route.params.table}/${route.params.id_peserta}`,
      {
        headers: {
...
function submitNilai(data) {
  ...
  axios
    .post(
      `${storeApp.baseurl}cbt/panitia/test/store-nilai/${route.params.table}/${data.id}`,
      {
        nilai: data.nilai,
      },
      {
