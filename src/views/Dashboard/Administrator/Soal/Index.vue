...
onBeforeMount(() => {
  fetchData(`${storeApp.baseurl}cbt/admin-pusbang/soal/list`);
});
...
function changeFile(e) {
  ...
  axios
    .post(`${storeApp.baseurl}cbt/admin-pusbang/soal-import`, formData, {
      headers: {
          ...
          <div class="d-flex">
            ...
            <div class="dropdown">
              <button
                ...
                aria-expanded="false"
              >
                <span><i class="fas fa-plus me-2"></i>CREATE</span>
              </button>
              <ul
                class="dropdown-menu rounded-2"
                style="position: fixed !important; right: 0; left: auto"
