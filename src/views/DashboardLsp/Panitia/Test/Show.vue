...
onBeforeMount(() => {
  ...
  fetchQuestionNotInTest(
    `${storeApp.baseurl}cbt/lsp/panitia/soal/${route.params.id_test}/not-in-test/${route.params.table}`
  );
});
...
function fetchData() {
  ...
  axios
    .get(
      `${storeApp.baseurl}cbt/lsp/panitia/test/${route.params.id_test}/show/${route.params.table}`,
      {
        headers: {
...
function fetchTemplate() {
  ...
  axios
    .get(`${storeApp.baseurl}cbt/lsp/panitia/template/for-select`, {
      headers: {
        Authorization: `Bearer ${storeApp.tokenPanitia}`,
      },
    })
...
function submit() {
  ...
  axios
    .post(
      `${storeApp.baseurl}cbt/lsp/panitia/test/attach-pertanyaan`,
      {
        bobot,
