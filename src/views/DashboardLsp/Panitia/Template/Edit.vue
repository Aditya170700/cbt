...
onMounted(() => {
  ...
  axios
    .get(
      `${storeApp.baseurl}cbt/lsp/panitia/template/${route.params.id}/show`,
      {
        headers: {
    ...
    .then((res) => {
      ...
      fetchSoal(`${storeApp.baseurl}cbt/lsp/panitia/soal/for-template`);
    })
    .catch((err) => {
      form.loadingData = false;
      console.log(err);
...
function submit() {
  ...
  axios
    .put(
      `${storeApp.baseurl}cbt/lsp/panitia/template/${route.params.id}`,
      {
        name: form.name,
    ...
    .then((res) => {
      ...
      router.push({ name: "dashboard-lsp-panitia-template" });
    })
    .catch((err) => {
      form.loading = false;
                  ...
                  <div class="col-6">
                    <div class="input-group mb-3 bg-white rounded-2 shadow">
                      ...
                      <button
                        ...
                        @click="
                          fetchSoal(
                            `${storeApp.baseurl}cbt/lsp/panitia/soal/for-template`
                          )
                        "
                      >
