...
onBeforeMount(() => {
  fetchData(`${storeApp.baseurl}cbt/lsp/panitia/soal/list`);
});
...
function destroy(data) {
  confirmation("Yakin hapus data ini?").then((confirmed) => {
    if (confirmed) {
      data.loading = true;
      axios
        .delete(`${storeApp.baseurl}cbt/lsp/panitia/soal/${data.id}/destroy`, {
          headers: {
            Authorization: `Bearer ${storeApp.tokenPanitia}`,
          },
        })
...
function changeFile(e) {
  ...
  axios
    .post(`${storeApp.baseurl}cbt/lsp/panitia/soal-import`, formData, {
      headers: {
                    ...
                    :to="{
                      name:
                        data.tipe == 'Multiple Choice'
                          ? 'dashboard-lsp-panitia-soal-edit-multiple-choice'
                          : 'dashboard-lsp-panitia-soal-edit-essay',
