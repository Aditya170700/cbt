...
onBeforeMount(() => {
  fetchData(`${storeApp.baseurl}cbt/lsp/admin-pusbang/soal/list`);
});
...
function destroy(data) {
  confirmation("Yakin hapus data ini?").then((confirmed) => {
    if (confirmed) {
      ...
      axios
        .delete(
          `${storeApp.baseurl}cbt/lsp/admin-pusbang/soal/${data.id}/destroy`,
          {
            headers: {
              Authorization: `Bearer ${storeApp.tokenAdministratorPelatihan}`,
            },
...
function changeFile(e) {
  ...
  axios
    .post(`${storeApp.baseurl}cbt/lsp/admin-pusbang/soal-import`, formData, {
      headers: {
          ...
          <div class="col-lg-4">
            <div class="input-group mb-3 bg-white rounded-2 shadow">
              ...
              <button
                ...
                @click="
                  fetchData(
                    `${storeApp.baseurl}cbt/lsp/admin-pusbang/soal/list`
                  )
                "
              >
                    ...
                    :to="{
                      name:
                        data.tipe == 'Multiple Choice'
                          ? 'dashboard-lsp-administrator-soal-edit-multiple-choice'
                          : 'dashboard-lsp-administrator-soal-edit-essay',
