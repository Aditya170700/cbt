...
onMounted(() => {
  ...
  axios
    .get(
      `${storeApp.baseurl}cbt/lsp/instruktur/template/${route.params.id}/show`,
      {
        headers: {
    ...
    .then((res) => {
      ...
      fetchSoal(`${storeApp.baseurl}cbt/lsp/instruktur/soal/for-template`);
    })
    .catch((err) => {
      form.loadingData = false;
      console.log(err);
...
function submit() {
  ...
  axios
    .put(
      `${storeApp.baseurl}cbt/lsp/instruktur/template/${route.params.id}`,
      {
        name: form.name,
    ...
    .then((res) => {
      ...
      router.push({ name: "dashboard-lsp-instruktur-template" });
    })
    .catch((err) => {
      form.loading = false;
      ...
      <div class="container p-lg-4">
        <div class="d-flex px-2 mb-4 justify-content-between">
          ...
          <div class="col-5 col-lg-3 text-end mb-3">
            <router-link
              :to="{ name: 'dashboard-lsp-instruktur-template' }"
                  ...
                  <div class="col-6">
                    <div class="input-group mb-3 bg-white rounded-2 shadow">
                      ...
                      <button
                        ...
                        @click="
                          fetchSoal(
                            `${storeApp.baseurl}cbt/lsp/instruktur/soal/for-template`
                          )
                        "
                      >
