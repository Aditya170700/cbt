...
function fetchData() {
  ...
  axios
    .get(
      `${storeApp.baseurl}cbt/lsp/instruktur/test/${route.params.id_test}/list-jawaban/${route.params.table}/${route.params.id_peserta}`,
      {
        headers: {
...
function submitNilai(data) {
  ...
  axios
    .post(
      `${storeApp.baseurl}cbt/lsp/instruktur/test/store-nilai/${route.params.table}/${data.id}`,
      {
        nilai: data.nilai,
      },
      {
