...
function fetchData() {
  ...
  axios
    .get(
      `${storeApp.baseurl}cbt/lsp/instruktur/test/${route.params.id_test}/show/${route.params.table}`,
      {
        headers: {
...
function fetchTemplate() {
  ...
  axios
    .get(`${storeApp.baseurl}cbt/lsp/instruktur/template/for-select`, {
      headers: {
        Authorization: `Bearer ${storeApp.tokenInstruktur}`,
      },
    })
...
function submit() {
  ...
  axios
    .post(
      `${storeApp.baseurl}cbt/lsp/instruktur/test/attach-pertanyaan`,
      {
        bobot,
