...
onMounted(() => {
  ...
  axios
    .get(
      `${storeApp.baseurl}cbt/lsp/instruktur/soal/${route.params.id_soal}/show`,
      {
        headers: {
...
function submit() {
  ...
  axios
    .put(
      `${storeApp.baseurl}cbt/lsp/instruktur/soal/${route.params.id_soal}/update`,
      form,
      {
        headers: {
          Authorization: `Bearer ${storeApp.tokenInstruktur}`,
...
function destroyOpsi(data, iopt) {
  confirmation("Yakin hapus data ini?").then((confirmed) => {
    if (confirmed) {
      ...
      axios
        .delete(
          `${storeApp.baseurl}cbt/lsp/instruktur/soal/${route.params.id_soal}/destroy-opsi/${data.id}`,
          {
            headers: {
              Authorization: `Bearer ${storeApp.tokenInstruktur}`,
            },
