...
onBeforeMount(() => {
  fetchData(`${storeApp.baseurl}cbt/lsp/instruktur/soal/list`);
});
...
function destroy(data) {
  confirmation("Yakin hapus data ini?").then((confirmed) => {
    if (confirmed) {
      ...
      axios
        .delete(
          `${storeApp.baseurl}cbt/lsp/instruktur/soal/${data.id}/destroy`,
          {
            headers: {
              Authorization: `Bearer ${storeApp.tokenInstruktur}`,
            },
...
function changeFile(e) {
  ...
  axios
    .post(`${storeApp.baseurl}cbt/lsp/instruktur/soal-import`, formData, {
      headers: {
                    ...
                    :to="{
                      name:
                        data.tipe == 'Multiple Choice'
                          ? 'dashboard-lsp-instruktur-soal-edit-multiple-choice'
                          : 'dashboard-lsp-instruktur-soal-edit-essay',
